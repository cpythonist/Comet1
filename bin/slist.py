...
helpStr = (
    ...
    "USAGE: list [-h] [-n] [-p] [-m] [process ...]", "ARGUMENT(S)",
    "\tprocess", "\t\tThe name of the process(es) to search for",
    "OPTION(S)", "\t-h / --help", "\t\tHelp message", "\t-n / --name",
...
def LIST(interpreter: comet.Interpreter, command: str, args: dict[int, str],
